    ...
    <div class="container">
        <div class="row">
            <div class="col-md-2 col-sm-2">
                <div class="logo"><a href="index.html"><img src="client/images/logo.png" alt="FlatShop"></a>
                </div>
            </div>
                    ...
                    <ul class="option">
                        ...
                        <li class="option-cart">
                            ...
                            <ul class="option-cart-item">
                                <li>
                                    <div class="cart-item">
                                        <div class="image"><img src="/images/products/thum/products-01.png" alt="">
                                        </div>
                                        <div class="item-description">
                                            <p class="name">Lincoln chair</p>
                                            <p>Size: <span class="light-red">One
                                                    size</span><br>Quantity: <span class="light-red">01</span></p>
                                        </div>
                                        <div class="right">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6">
                                            <ul class="mega-menu-links">
                                                ...
                                                <li><a href="productgird.html">Blazers & Jackets</a>
                                                </li>
